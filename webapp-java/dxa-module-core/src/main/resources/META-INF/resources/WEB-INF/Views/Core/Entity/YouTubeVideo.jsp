...
<jsp:useBean id="entity" type="com.sdl.dxa.modules.core.model.entity.YouTubeVideo" scope="request"/>
            ...
            <c:choose>
                <c:when test="${not empty entity.url}">
                    <div class="embed-video">
                        <img src="${mediaHelper.getResponsiveImageUrl(entity.url, "100%", 0.0, 0)}"
                             alt="${entity.headline}">
                        <button type="button" data-video="${entity.youTubeId}">
                            <i class="fa fa-play-circle"></i>
                        </button>
                ...
                <c:otherwise>
                    <iframe src="https://www.youtube.com/embed/${entity.youTubeId}?version=3&enablejsapi=1"
                            id="video${uuid}"></iframe>
                </c:otherwise>
            </c:choose>
        </div>
    </c:otherwise>
