...
<jsp:useBean id="pageModel" type="com.sdl.dxa.modules.model.TSI811.Tsi811PageModel" scope="request"/>
...
<body>
<h1>Rendered ${pageModel} with Page View "Test:TSI811TestPage"</h1>
