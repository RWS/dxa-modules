...
@ToString
@Slf4j
public class SmartTargetPageModel extends AbstractPageModelImpl implements PageModel.WithResponseData {
    ...
    public boolean setResponseData(HttpServletResponse httpServletResponse) {
        ...
        CookieProcessor.saveExperimentCookies(httpServletResponse, null, this.newExperimentCookies);
        return true;
    }
}
