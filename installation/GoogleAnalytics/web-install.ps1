<#
.Synopsis
   Deploys Google Analytics module to web application
.DESCRIPTION
   Deploys Google Analytics module to web application
.EXAMPLE
...
if (!($pscmdlet.ShouldProcess("System", "Deploy Google Analytics module in web application"))) { return }
...
Write-Output ("Copied views and DLLs for Google Analytics module")
