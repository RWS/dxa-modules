<#
.Synopsis
   Deploys Impress module to web application
.DESCRIPTION
   Deploys Impress module to web application
.EXAMPLE
...
if (!($pscmdlet.ShouldProcess("System", "Deploy Impress module in web application"))) { return }
...
Write-Output ("Copied views and DLLs for Impress module")
