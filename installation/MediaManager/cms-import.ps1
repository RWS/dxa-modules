<#
.Synopsis
   Import the Media Manager Module into CMS
.DESCRIPTION
   Import the Media Manager Module into CMS
.EXAMPLE
...
if (!($pscmdlet.ShouldProcess("System", "Import Media Manager Module into CMS"))) { return }
...
$importPackageFullPath = Join-Path $distSource "module-MediaManager.zip"
