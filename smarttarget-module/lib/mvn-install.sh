...
mvn -q install:install-file -DgroupId=com.tridion -DartifactId=smarttarget_odata_cartridge -Dversion=2.1.0 -Dpackaging=jar -Dfile=smarttarget_odata_cartridge-2.1.0.jar
