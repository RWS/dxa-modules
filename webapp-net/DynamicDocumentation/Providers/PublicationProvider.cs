...
using Publication = Sdl.Web.Modules.DynamicDocumentation.Models.Publication;
    ...
    public class PublicationProvider
    {
        ...
        public List<Publication> PublicationList
        {
            get
            {
                ...
                {
                    throw new ApiException("Unable to fetch list of publications.", e);
                }
            }
        }
        ...
        public void CheckPublicationOnline(int publicationId)
        {
            ...
            if (isOffline)
            {
                throw new ApiException($"Unable to find publication {publicationId}");
            }
        }

        private Publication BuildPublicationFrom(PublicContentApi.ContentModel.Publication publication)
        {
