...
{
    public class IqSearchResult : IQueryResult
    {
    ...
    public class IqSearchResultWrapped : IQueryResult
    {
        private readonly IqSearchResult _wrapped;

        public IqSearchResultWrapped(IqSearchResult searchResult)
        {
