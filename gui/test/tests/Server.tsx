                                ...
                                <div className="sdl-dita-delivery-page">
                                    ...
                                    <div className="sdl-dita-delivery-breadcrumbs">
                                        <ul>
                                            ...
                                            <li>
                                                <a title="Unable to retrieve metadata for publication with id 123."
                                                    href="#/123/unable-to-retrieve-metadata-for-publication-with-id-123-">
                                                    Unable to retrieve metadata for publication with id 123.</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div/>
