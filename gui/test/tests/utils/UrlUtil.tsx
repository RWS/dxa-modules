    ...
    public runTests(): void {
        ...
        describe(`Url utils tests.`, (): void => {
            ...
            it("encodes publication url to safe format", (): void => {
                ...
                expect(publicationLocation).toBe("/777-1-1/veroffentlichung%E2%84%96%D0%BF%D1%8F%D1%82%D1%8C%E3%82%B3%E3%83%B3%E3%82%BB%E3%83%97%E3%83%88");
            });

            it("encodes page url to safe format", (): void => {
                const pageLocation = Url.getPageUrl("777-1-1", "1656863-164282-16", "Veröffentlichung № пять", "¿Qué? ●");
                expect(pageLocation).toBe("/777-1-1/1656863-164282-16/veroffentlichung-%E2%84%96-%D0%BF%D1%8F%D1%82%D1%8C/%C2%BFque--%E2%97%8F");
            });
